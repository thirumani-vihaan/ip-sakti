...
def build_prompt(query: str, evidence: list[RetrievalHit]) -> str:
    lines = [
        ...
        "- If the question or document is completely unrelated to Ayurveda, Traditional Knowledge, or Intellectual Property, you MUST reply exactly with: INSUFFICIENT_EVIDENCE.",
        "- Otherwise, if the evidence below does not fully answer the question, you MUST use your own external knowledge to provide a comprehensive legal answer.",
        "- Even if using your own knowledge (for relevant topics), you MUST end every factual sentence with the first evidence id provided in [brackets] to satisfy the system format.",
